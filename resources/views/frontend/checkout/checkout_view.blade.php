...
@section('content')
    ...
    <main class="main">
        <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
            <div class="container">
                <h1 class="page-title">Ödeme Yap</h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ödeme Yap</li>
                </ol>
            </div><!-- End .container -->
                    ...
                    <form action="{{ route('checkout.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <aside class="col-lg-3">
                                <div class="summary">
                                    <h3 class="summary-title">Siparişlerin</h3><!-- End .summary-title -->
                                    ...
                                    <button type="submit" class="btn btn-outline-primary-2 btn-order btn-block">
                                        ...
                                        <span class="btn-hover-text">Ödeme Sayfasına Git</span>
                                    </button>
                                </div><!-- End .summary -->
                            </aside><!-- End .col-lg-3 -->
                        </div><!-- End .row -->
